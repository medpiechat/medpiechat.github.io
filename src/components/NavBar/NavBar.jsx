            ...
            <div className="flex items-center justify-between lg:w-[65rem] md:w-[100%] px-4 md:px-3 py-5 m-auto text-lg">
                <div className="flex items-center">
                    <Link style={{ textDecoration: "none" }} to="/">
                        {/* !!!!!note that the tesla tab is located here; we need resize this: className="h-10" */}
                        <img src="/images/logolatest.png" alt="logo" style={{maxWidth: '10%',height: 'auto'}} className="h-10"/>
                    </Link>
                    
                </div>
                <div className="flex items-center">
                    {/*  className=""*/}
                    <ul className="md:flex  hidden items-center text-base">
                        <li className="mr-8">
